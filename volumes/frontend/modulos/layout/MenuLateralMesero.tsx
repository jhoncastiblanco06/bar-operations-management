...
import { API_URL } from "../../utilidades/api"; // 👈 IMPORTANTE: Asegúrate de que esta ruta sea correcta

export default function MenuLateralMesero() {
  ...
  // 🚀 USEEFFECT MEJORADO: Trae los datos frescos del backend
  // 🚀 USEEFFECT MEJORADO: Trae los datos y escucha actualizaciones
  useEffect(() => {
    ...
    // 🚀 MAGIA: Nos suscribimos al evento del "Megáfono"
  ...
  const menuOperacion = [
    { nombre: "Mapa de Mesas", ruta: "/mesero", icono: "🪑" },
  ];
      ...
      >
        ...
        <div className="p-6 border-b border-gray-800 shrink-0 bg-gray-900/20">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-12 h-12 rounded-full overflow-hidden bg-purple-500/20 flex items-center justify-center text-purple-400 font-black text-xl border-2 border-purple-500/30 shrink-0">
              {datosUsuario.avatar ? (
                <img
        ...
        <div className="p-4 border-t border-gray-800 bg-gray-950 flex flex-col gap-2 shrink-0">
          <Link
            href="/mesero/configusr" // 👈 Asegúrate de crear este archivo src/app/mesero/perfil/page.tsx luego
            onClick={() => setAbierto(false)}
